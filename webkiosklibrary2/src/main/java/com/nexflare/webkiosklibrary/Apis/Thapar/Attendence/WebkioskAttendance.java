...
public class WebkioskAttendance implements WebkioskContract<AttendanceResult> {
    ...
    private static String URL = "https://webkiosk.thapar.edu/StudentFiles/StudentPage.jsp";
                ...
                try {
                    ...
                    if (document.body().toString().toLowerCase().contains("session timeout")) {
                        ...
                        for (Element element : elements) {
                            ...
                            attendance.setDetailAttendanceUrl(Constants.INITIAL_URL_THAPAR_ACADEMIC + subElements.get(5).getElementsByTag("a").attr("href"));
                            ...
                            if (attendance.getOverallAttendance() == null
                                ...
                                if (detailAttendanceUrl != null && detailAttendanceUrl.length() != 0) {
                                    attendance.setDetailAttendanceUrl(Constants.INITIAL_URL_THAPAR_ACADEMIC + detailAttendanceUrl);
                                } else {
